...
export default {
    'GET /mock/umps/user/list': (req, res) => {
    ...
    'GET /mock/umps/user/detail': (req, res) => {
    ...
    'POST /mock/umps/user/create': (req, res) => {
        return res.json({
            error: '',
            state: 1,
            data: {
    ...
    'POST /mock/umps/user/edit': (req, res) => {
        return res.json({
            error: '',
            state: 1,
            data: {
    ...
    'POST /mock/umps/user/delete': (req, res) => {
        return res.json({
            error: '',
            state: 1,
            data: {
